...
-- 1. What is the gender breakdowm of employees in the company?
...
-- 2. What is the race/ethinicity breakdown of emplpyees in the company?
...
SELECT      -- datediff() calculates the difference between dates, curdate() is current date
